...
export const SETTING_MEDIA_PASTE_BEHAVIOR = 'media.pasteBehavior';
export const SETTING_MEDIA_PASTE_FOLDER = 'media.pasteFolder';
export const SETTING_MEDIA_PASTE_FILENAME = 'media.pasteFileName';
